...
if [[ $version == 3.6* ]]; then
    ...
    python -m pip install "numpy==1.14.6" "cython~=3.0.0"
elif [[ $version == 3.8* ]]; then
    python -m pip install "numpy==1.17.5" "cython~=3.0.0"
elif [[ $version == 3.9* ]]; then
    python -m pip install "numpy==1.19.3" "cython~=3.0.0"
elif [[ $version == 3.10* ]]; then
    python -m pip install "numpy==1.21.6" "cython~=3.0.0"
elif [[ $version == 3.11* ]]; then
    python -m pip install "numpy==1.23.2" "cython~=3.0.0"
elif [[ $version == 3.12* ]]; then
    python -m pip install "numpy==1.26.2" "cython~=3.0.0"
else
